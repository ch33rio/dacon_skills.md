...
- Start intake: use the pre-filled email above first. Signed-in GitHub buyers can use the [structured buy form](https://github.com/ch33rio/dacon_skills.md/issues/new?template=buy-workflow-audit.yml), [public intake thread](https://github.com/ch33rio/dacon_skills.md/issues/1), or [general request form](https://github.com/ch33rio/dacon_skills.md/issues/new?template=workflow-audit-request.md).
